...
```env
AUTH_ISSUER=http://localhost:8080/realms/customer-spend-microservice
AUTH_AUDIENCE=customer-spend-microservice-api
AUTH_JWKS_URL=http://localhost:8080/realms/customer-spend-microservice/protocol/openid-connect/certs
```
